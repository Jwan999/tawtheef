<template>
    ...
    <div class="flex justify-end -mt-28">
        <div class="w-10/12 bg-zinc-800 text-white py-32 rounded-l-full">
            <div class="flex justify-center items-center w-full">
                <div class="w-10/12">
                    <div class="w-8/12 flex flex-wrap">
                        <h1 class="text-5xl font-bold">Discover Exceptional Talent or Inspiring Resumes <span class="text-orange">Right Here</span></h1>
    ...
    <div v-if="showAdvanceSearch" class="bg-white text-dark rounded-md p-4 mt-10">
        ...
        <div class="grid grid-cols-2 gap-4 ">
            ...
            <select v-model="degree"
                    class="focus:border-orange focus:ring-0 bg-zinc-50 w-full rounded-md md:text-sm text-sm border-0 border-b-[1px] border-zinc-300 hover:border-orange focus:outline-none">
