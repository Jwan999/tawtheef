                                ...
                                <div class="flex w-full items-center mt-3">
                                    <div class="border-[1px] border-orange p-1 rounded-tr-3xl rounded-bl-3xl w-64">
                                      <div v-if="applicant.image">
                                          <img v-if="applicant.image.startsWith('data:')" class="h-44 object-cover w-full rounded-md"
                                               :src="applicant.image" alt="">
                                          <img v-if="!applicant.image.startsWith('data:')" class="h-44 rounded-tr-3xl rounded-bl-3xl object-cover w-full"
...
<!--                                        <img class="  h-44 rounded-tr-3xl rounded-bl-3xl"-->
<!--                                             :src="`/storage/${applicant.image}`" alt="">-->
                                    </div>
                                </div>
                                <div class="mt-3">
