<template>
    <div :class="[rounded, 'relative bg-white w-72 p-4 inline-block cursor-pointer']">
                    ...
                    <div class="border-[1px] border-orange p-1 rounded-tr-3xl rounded-bl-3xl w-64">
                        <div v-if="applicant.image">
                            <img
                                ...
                                class="h-44 object-cover w-full rounded-md"
                                :src="applicant.image"
                                alt=""
                            >
                            <img
                                v-else
                                class="h-44 rounded-tr-3xl rounded-bl-3xl object-cover w-full"
                                :src="`/storage/${applicant.image}`"
                                alt=""
                            >
                        </div>
                        <div v-else class="flex justify-center items-center h-44 bg-zinc-100 rounded-tr-3xl rounded-bl-3xl">
