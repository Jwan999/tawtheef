<template>
    <Transition name="fade">
        <div v-if="showComponent" class="bg-zinc-50 rounded-tr-3xl rounded-bl-3xl border-[1px] border-orange p-6">
...
watch(activeFilters, (newFilters) => {
    if (Object.keys(newFilters).length === 0) {
        // If all filters are removed, hide the component after 3 seconds
        setTimeout(() => {
            showComponent.value = false;
        }, 3000);
    } else {
        // If there are active filters, make sure the component is visible
