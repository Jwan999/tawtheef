        ...
        <div class="flex w-full relative space-x-0 md:space-x-6">
            ...
            <div class="md:w-3/12">
                ...
                'fixed md:relative inset-y-0 left-0 z-40',mobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0','flex flex-col','pt-4']">
                    <div class="flex items-center space-x-6 pb-6 border-b-[1px] border-zinc-200 mx-4">
                        <div class="space-y-2 w-3/12">
                            <img v-if="image" class="rounded-tr-2xl object-cover rounded-bl-xl h-14 w-full"
                                 :src="`/storage/${image}`"
                                 alt="">
                            <svg v-else class="h-14 w-full fill-dark" viewBox="-42 0 512 512.002" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="w-8/12 space-y-3 ">
                            <h1 class="text-lg font-semibold tracking-wide capitalize">{{ contact.fullName }}</h1>
